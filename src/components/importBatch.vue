...
<template>
  <div class="container">
    <FileUpload name="tickets[]" url="http://localhost:3000/upload_files" @upload="onTemplatedUpload($event)" :multiple="true" accept=".AIR" :maxFileSize="1000000" @select="onSelectedFiles">
