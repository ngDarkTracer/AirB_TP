...
<template>
  <div class="container">
    <FileUpload name="ticket" url="http://localhost:3000/upload_file" @upload="onTemplatedUpload($event)" :multiple="true" accept=".AIR" :maxFileSize="1000000" @select="onSelectedFiles">
      ...
      <template #empty>
        <div class="flex align-items-center justify-content-center flex-column">
          ...
          <p class="mt-4 mb-0">Drag and drop file to here to upload.</p>
        </div>
      </template>
    </FileUpload>
  </div>
